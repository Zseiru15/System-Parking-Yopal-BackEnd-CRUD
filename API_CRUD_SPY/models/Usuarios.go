...
type Usuarios struct {
	...
	Membresia                    bool              `orm:"column(Membresia);null"`
	InicioMembresia              time.Time         `orm:"column(Inicio_Membresia);type(timestamp with time zone);null"`
...
func GetUsuarioByEmail(email string) (*Usuarios, error) {
	o := orm.NewOrm()
